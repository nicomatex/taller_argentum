...
VisualCharacterComponent::VisualCharacterComponent(int head_id, int body_id,int weapon_id, int offhand_id) {
    if (head_id != 0) {
    ...
    if (body_id != 0) {
        Actor body(
            ResourceManager::get_instance().get_animation_pack("bodies", body_id),
