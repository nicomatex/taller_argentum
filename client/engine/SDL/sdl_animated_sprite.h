...
class SDLSprite {
   ...
   public:
    ...
    esta compuesta la animacion, los cuadros por segundo a los cuales debe
    reproducirse la altura base a la cual comienza la sprite en la textura, el
    ancho y el alto de cada cuadro, y el cuadro a renderizar cambia cada ciertos
    intervalos de tiempo, asegurandose de que se rendericen como maximo fps
    cuadros del sprite por segundo (pueden ser menos). */
