...
typedef enum {mage = 1, cleric = 2, paladin = 3, warrior = 4} class_type_t;
...
class AttributeManager {
   ...
   public:
   	...
   	static void init(const char *stats_file = "stats.json",
   			         const char *races_file = "races.json",
   			         const char *classes_file = "classes.json");
